...
from .views import HomeView, CategoryDetailView, AddItemView, AddByDirectorView, SwipeRatingView, StatsView, DecadeStatsView, EclecticView, DivisiveView, MovieDetailView
